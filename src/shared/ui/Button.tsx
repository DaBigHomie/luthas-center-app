...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    'bg-color-primary text-color-text-inverse border-transparent hover:bg-color-primary-hover',
  secondary:
    'bg-color-surface-raised text-color-text border border-color-border hover:bg-color-surface-overlay hover:text-color-text-inverse',
  ghost:
    'bg-transparent text-color-primary border border-color-primary hover:bg-color-surface-overlay hover:text-color-text-inverse',
  link: 'bg-transparent text-color-primary border-transparent underline-offset-4 hover:underline',
  danger:
    'bg-color-error text-color-text-inverse border-transparent hover:opacity-90',
}

const sizeClasses: Record<ButtonSize, string> = {
  sm: 'px-spacing-3 py-spacing-2 text-sm min-h-[32px]',
  md: 'px-spacing-5 py-spacing-3 text-base min-h-[40px]',
  lg: 'px-spacing-6 py-spacing-4 text-lg min-h-[48px]',
}
